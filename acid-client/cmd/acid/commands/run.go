...
const runUsage = `Send an Acid JS file to the server.

This sends a file into the cluster and waits for it to complete. It accepts
a project name or project ID.

	$ acid run deis/empty-testbed

When no JS file is supplied, the project will be checked for an acid.js file
...
func init() {
	run.Flags().StringVarP(&runFile, "file", "f", "./acid.js", "The JavaScript file to execute")
