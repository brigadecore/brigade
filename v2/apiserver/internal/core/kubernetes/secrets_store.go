...
// secretsStore is a Kubernetes-based implementation of the core.SecretsStore
// interface.
...
// core.SecretsStore interface.
func NewSecretsStore(kubeClient kubernetes.Interface) core.SecretsStore {
	return &secretsStore{
