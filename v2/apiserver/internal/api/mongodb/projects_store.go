...
// projectsStore is a MongoDB-based implementation of the api.ProjectsStore
// interface.
...
func (p *projectsStore) Update(
	ctx context.Context, project api.Project,
) error {
