 ...
 * Rewrite pretty-printing HTML elements to prevent throwing internal errors Fixes errors occurring when using a non-native DOM implementation
...
==================
  ...
  * adding codex as doc dependency
  * prepping for docs
