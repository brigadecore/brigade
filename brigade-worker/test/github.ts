...
import {BrigadeEvent} from "../src/events";
import {extractEnv} from "../src/github";

describe("extractEnv", function() {
    describe("pull request", function () {
        const e = new BrigadeEvent()
        e.type = "pull_request"
        e.payload = `{
  "action": "opened",
  "number": 1,
  ...
  "installation": {
    "id": 234
        ...
        assert.deepEqual(extractEnv(e), { GITHUB_EVENT_TYPE: "pull_request",
            GITHUB_PULL_REQUEST: "1",
            GITHUB_REF: "",
            GITHUB_REF_TYPE: "",
            GITHUB_BASE_REF: "master",
            GITHUB_HEAD_REF: "changes" })
    })
  ...
  "sender": {
    ...
    "site_admin": false
        ...
        assert.deepEqual(extractEnv(e), { GITHUB_EVENT_TYPE: "push",
            GITHUB_PULL_REQUEST: "",
            GITHUB_REF: "refs/heads/changes",
            GITHUB_REF_TYPE: "",
            GITHUB_BASE_REF: "",
            GITHUB_HEAD_REF: "" })
    })
  ...
  "sender": {
    ...
    "site_admin": false
        ...
        assert.deepEqual(extractEnv(e), { GITHUB_EVENT_TYPE: "create",
            GITHUB_PULL_REQUEST: "",
            GITHUB_REF: "0.0.1",
            GITHUB_REF_TYPE: "tag",
            GITHUB_BASE_REF: "",
